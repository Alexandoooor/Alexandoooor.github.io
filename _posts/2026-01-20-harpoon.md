...
to be able to quickly jump between them.

I find this useful as I often encounter a situation where I jump between a few directories multiple times.
...
This name can then be referenced to quickly jump to the corresponding path.
